...
3. [Manifest reference](manifest-reference.md) — the `arcturus.u128.org/v2` release contract.
4. [Operations](operations.md) — status, verification, logs, rollback, disable/enable, and removal.
5. [Security model](security.md) — authentication, secret boundaries, host exposure, and release integrity.
6. [Migration](migration.md) — moving production ownership away from Compose, Terraform provisioners, and Watchtower.
